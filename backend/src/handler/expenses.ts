 ...
 */
export const searchExpenses = async (event: APIGatewayProxyEvent): Promise<APIGatewayProxyResult> => {
  try {
 ...
 */
export const bulkCreateExpenses = async (event: APIGatewayProxyEvent): Promise<APIGatewayProxyResult> => {
  try {
    const userId = getUserId(event)
